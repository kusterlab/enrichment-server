...
RUN apt-get update
RUN apt-get install -y curl libcurl4-openssl-dev libssl-dev libomp5 libopenblas-dev libfontconfig1-dev libxml2-dev python3-poetry git r-base #Will install R=4.3.2
